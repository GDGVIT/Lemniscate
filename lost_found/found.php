...
<h3 class="header light center">Add Found Item</h3>
<h5 class="header light center">Please enter the details below of the item that you have found:</h5>
<div class="container row">
  <form action = "found_item.php"class="col s12" method = "GET">
    <div class="row">
    ...
    <div class="row">
      <div class="input-field col s12 m7">
        ...
        <div class="input-field col s12 m5">
          <label>Hander over</label><input type="text" name="handed_over">
        </div>
      </div>
      <div class="row">
