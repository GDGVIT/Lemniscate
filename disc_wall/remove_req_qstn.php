...
//disc-wall
    ...
    if(isset($_REQUEST['id']))
    {
        ...
        $qstn_id=$_REQUEST['id'];
        $sql_ans_req="DELETE FROM `ans_req_likes` WHERE req_ans_reg_no='$login_name' AND qstn_id='$qstn_id';";
        ...
        if($res_ans_req==true)
        {
            ...
            if($res_inc_ans_req==true)
            {
                ...
                echo "<div id='want_ans_".$qstn_id."'><button onclick='ans_req(this.id)' id='$qstn_id' >Even I need the answer</button></div>";
