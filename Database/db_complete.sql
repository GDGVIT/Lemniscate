...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2015 at 05:41 AM
...
--
-- Table structure for table `ans_req_likes`
--

CREATE TABLE IF NOT EXISTS `ans_req_likes` (
...
--
-- Table structure for table `likes_upvotes`
--

CREATE TABLE IF NOT EXISTS `likes_upvotes` (
...
--
-- Dumping data for table `likes_upvotes`
--

INSERT INTO `likes_upvotes` (`unique_id_post`, `regno_liked`, `table_unique_id`) VALUES
(2, 'a1', 3),
(3, 'a1', 7),
(5, 'a1', 11),
(7, 'a1', 13);
...
INSERT INTO `post_table` (`unique_id`, `regno`, `post_text`, `no_of_likes_ans`, `status_qstn`, `date_time`, `pic_address`, `anoymous_status`, `total_no_replies`) VALUES
...
--
-- Table structure for table `reply_posts`
--
...
--
-- Dumping data for table `reply_posts`
--

INSERT INTO `reply_posts` (`unique_id`, `regno`, `comment_id`, `reply_id`, `date_reply`, `anoymous_status`, `likes_upvotes`, `reply_text`) VALUES
