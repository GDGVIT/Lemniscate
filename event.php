...
<head>
	...
	<title>Project : Lemniscate | Events</title>
...
<body>
	...
	<div class="nav-bar-container">
		...
		<div class="overlay">
			...
			<div class="logo">Lemniscate</div><!--.logo-->
		</div><!--.overlay-->
	...
	<div class="content">
		...
		<div class="col-md-12">
			<div style="position: fixed;bottom: 45px;right: 24px;z-index: 9999">
				<a class="btn btn-floating btn-deep-purple btn-ripple" title="Add Event"><i class="ion-android-add"></i></a>
			</div>
			<div class="panel">
				<div class="panel-heading">
					<div class="panel-title"><h4>Upcoming Events</h4>
						<div class="panel-inputs">
							<div class="input-group">
								<input type="text" class="form-control input-circle-left" placeholder="Search Events">
								<span class="input-group-btn"><button class="btn btn-circle-right btn-default btn-ripple" type="submit">Find</button> </span>
							</div>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<div class="timeline">
						<div class="frame">
							...
							<span class="timeline-date">11 June 2015</span>
							<div class="timeline-bubble">
								<h4>EventOne</h4>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum augue dui, ultrices hendrerit nisi non, convallis dictum purus. Proin vel dapibus sapien. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Quisque vitae dapibus lectus.</p>
							</div>
						</div>
						<div class="frame">
							<div class="timeline-badge">
							...
							<span class="timeline-date">17 September 2015</span>
							<div class="timeline-content">
								<div class="widget widget-event">
									<div class="widget-heading widget-bgimage sample-bg-image12"></div>
									...
									<div class="widget-footer">
										<div class="btn-group btn-merged btn-group-sm pull-right">
											<button type="button" class="btn btn-default btn-ripple">Attend</button>
											<button type="button" class="btn btn-default btn-ripple">Maybe</button>
											<button type="button" class="btn btn-default btn-ripple">Decline</button>
											<button type="button" class="btn btn-default btn-ripple"><i class="fa fa-ellipsis-h fa-lg"></i></button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="frame">
							...
							<span class="timeline-date">17 August 2015</span>
							<div class="timeline-bubble">
								<h4>EventThree</h4>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum augue dui, ultrices hendrerit nisi non, convallis dictum purus. Proin vel dapibus sapien. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Quisque vitae dapibus lectus.</p>
							</div>
						...
						<div class="frame">
							...
							<span class="timeline-date">17 July 2015</span>
							<div class="timeline-content">
		...
		<div class="footer-links margin-top-40">
			<div class="row no-gutters">
				<div class="col-sm-12 bg-indigo">
					<a href="http://gdgvitvellore.com">
						<span class="state">GDGVIT Vellore</span>
					</a>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.footer-links-->
	...
	<div class="layer-container">
		...
		<div class="menu-layer">
			<ul>
				...
				<li>
					<a href="javascript:;">Group 1</a>
					<ul class="child-menu">
						<li><a href="#">Tile 1</a></li>
						<li><a href="#">Tile 2</a></li>
						<li><a href="#">Tile 3</a></li>
					</ul>
				</li>
				<li>
					<a href="javascript:;">Group 2</a>
					<ul class="child-menu">
						<li><a href="#">Tile 1</a></li>
						<li><a href="#">Tile 2</a></li>
						<li><a href="#">Tile 3</a></li>
				...
				<div class="tab-pane fade" id="settings">
					<div class="col-md-6 col-md-offset-3">
						...
						<div class="settings-panel">
							<p class="text-grey">Here's where you can check your settings. If you need an extra information from us, do not hesitate to contact.</p>
